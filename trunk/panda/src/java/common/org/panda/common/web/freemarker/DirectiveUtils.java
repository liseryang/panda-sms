...
import org.panda.common.web.springmvc.DateTypeEditor;
...
public abstract class DirectiveUtils {
	...
	/**
	 * 在parms中获得指定名称属性的value
	 * @param name
	 * @param params
	 * @return
	 * @throws TemplateException 
	* @create  2012-3-24 上午10:50:22 liuyf
	* @history
	 */
	...
	/**
	 * 在parms中获得指定名称属性类型为long的value
	 * @param name
	 * @param params
	 * @return
	 * @throws TemplateException 
	* @create  2012-3-24 上午10:51:48 liuyf
	* @history
	 */
	...
	* @history
	...
	/**
	 * 在parms中获得指定名称属性类型为boolean的value
	 * @param name
	 * @param params
	 * @return
	 * @throws TemplateException 
