...
import static org.panda.common.web.Constants.MESSAGE;
...
import org.panda.common.web.CookieUtils;
import org.panda.common.web.session.SessionProvider;
import org.panda.common.web.springmvc.MessageResolver;
...
public class AdminContextInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest request,
		...
		//当!user.isSuper() 表示当时超级管理员时 不去判断权限  他拥有所有权限
